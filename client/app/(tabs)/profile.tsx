...
export default function profile() {
  ...
  const pickAvatar = async()=>{
    ...
    if(status !== 'granted'){
      Alert.alert("Permission neeeded", "Allow access to your photos to change avatar.");
      return;
    }
          ...
          <View style={styles.optionsSection}>
            <TouchableOpacity style={styles.optionRow}>
              <View style={styles.optionIcon}>
                <Ionicons name="settings-outline" size={20 } Colors={Colors.onSurfaceVariant}/>
              </View>
            ...
            <TouchableOpacity style={styles.optionRow}>
              <View style={styles.optionIcon}>
                <Ionicons name="notifications-outline" size={20 } Colors={Colors.onSurfaceVariant}/>
              </View>
            ...
            <TouchableOpacity style={styles.optionRow}>
              <View style={styles.optionIcon}>
                <Ionicons name="lock-closed-outline" size={20 } Colors={Colors.onSurfaceVariant}/>
              </View>
            ...
            <TouchableOpacity style={styles.optionRow}>
              <View style={styles.optionIcon}>
                <Ionicons name="help-circle-outline" size={20 } Colors={Colors.onSurfaceVariant}/>
              </View>
