...
export async function handleConversationEvent(sendedId: string, conversationId: string, event: any){
    try {
        ...
        conversation.participants.forEach((pId) => {
            ...
            if (participantId === sendedId) return;// Don't send back to sender
